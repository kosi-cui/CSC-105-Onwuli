/*queryselector all to get all the boxes and loop through it
for each box, then add the event listener and the function that runs when it gets clicked
For adding the x's and o's, you can do box.inner text = x
For deciding the winner, do a for loop and it goes increasing the counter.
At 4, and 7 then it changes to zero cuz thats a new row
*/
...
//when box is clicked, if player = x, then .innertext x
